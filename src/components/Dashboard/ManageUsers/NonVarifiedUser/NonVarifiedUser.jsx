...
const usersData = [
    {
        id: 1,
        name: 'Rupok',
        email: 'rupok124519@gmail.com',
        joinedAt: '11:14AM, 07 Aug 2025',
        status: 'Active',
    },
    {
        id: 2,
        name: 'Paid Premium Bin',
        email: 'paidpremiumbin@gmail.com',
    ...
    },
    {
        id: 3,
        name: 'Rusho Rusho',
        email: 'info@creativedesign.com.bd',
    ...
    },
    {
        id: 4,
        name: 'Hasan Vai',
        email: 'emvika934@tempimail.org',
        joinedAt: '07:47PM, 05 Aug 2025',
        status: 'Not verified',
    },
    {
        id: 5,
        name: 'WebX Cloud',
        email: 'gk15sj199h@tllubd.com',
        joinedAt: '09:00AM, 05 Aug 2025',
        status: 'Active',
    },
    // Add more users as needed...
];

const NonVarifiedUser = () => {
    ...
    return (
        <div className="p-4 md:p-4 bg-gray-100 dark:bg-gray-900 min-h-screen text-gray-800 dark:text-white">
            <div className="bg-white space-y-10 dark:bg-gray-800 p-4 shadow rounded-md">
                <h1 className="text-xl font-bold  pb-2 mb-4 text-[#00baff]">Non Verified Users</h1>
...
export default NonVarifiedUser;
