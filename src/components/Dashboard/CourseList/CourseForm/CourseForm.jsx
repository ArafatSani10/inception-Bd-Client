        ...
        try {
            ...
            if (res.data.success) {
                Swal.fire({
                    ...
                    iconColor: '#00baff',
                    customClass: {
                        popup: 'rounded-3xl shadow-2xl p-6 border-2 border-cyan-500 animate-fadeIn',
                        title: 'text-2xl font-bold text-cyan-400',
                        content: 'text-lg text-gray-300',
                        confirmButton: 'text-white bg-cyan-500 hover:bg-cyan-400 px-6 py-2 rounded-full font-semibold transition-all duration-300'
                    },
                });
        ...
        <div className="bg-gray-100 dark:bg-gray-900 text-sm">
            ...
            {loading && (
                <div className="absolute inset-0 bg-black/40 flex items-center justify-center z-50">
                    <div className="flex flex-col items-center">
                        ...
                        <p className="mt-3 text-white text-lg font-semibold">Creating course...</p>
                    </div>
                </div>
            )}
            ...
            >
                ...
                <section>
                    ...
                    </h3>               <div className="flex flex-wrap mt-4 gap-2 border border-gray-300 dark:border-gray-700 rounded-lg p-2 bg-white dark:bg-gray-800">
                        {tags.map((tag, index) => (
                            <span
                                key={index}
                ...
                <section className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-5">
                    <div>
                        <label className="block font-bold mb-1 text-gray-700 dark:text-gray-300">Starting Date</label>
                        <input
                            type="date"
                ...
                <section className="mt-5">
                    <label className="block font-bold mb-1 text-gray-700 dark:text-gray-300">Status</label>
                    <select
                        {...register("status")}
