...
const UserProfile = () => {
    ...
    return (
        <div className="flex flex-col md:flex-row min-h-screen bg-gray-100 dark:bg-gray-900 text-gray-900 dark:text-gray-100 transition-colors duration-500">
            ...
            {/* Sidebar */}
            <div className="w-full md:w-1/3 lg:w-1/4 bg-white dark:bg-gray-800 p-8 flex flex-col items-center shadow-xl rounded-tr-3xl rounded-br-3xl transition-colors duration-500">
                ...
                <div className="mt-6 w-full space-y-3">
                    <div className="flex items-center justify-between bg-gray-200 dark:bg-gray-700 p-3 rounded-lg shadow hover:shadow-lg transition-all duration-300">
            ...
            <div className="flex-1 p-3 space-y-6">
                <h1 className="text-3xl font-bold text-purple-500 dark:text-purple-400 mb-4">Profile Details</h1>
