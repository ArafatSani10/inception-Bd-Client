...
const CountUp = ({ end, duration = 2, start }) => {
    ...
    useEffect(() => {
        ...
        const step = (timestamp) => {
            const progress = Math.min((timestamp - startTime) / (duration * 3000), 1);
...
// Sample Icon (you'll replace with others as needed)
const StudentIcon = () => (
...
const EstimatedCount = () => {
    ...
    const stats = [
        { id: 1, value: 50000, suffix: '+', label: 'Students Enrolled', icon: <StudentIcon /> },
        { id: 2, value: 500, suffix: '+', label: 'Expert Instructors', icon: <StudentIcon /> },
        { id: 3, value: 1200, suffix: '+', label: 'Active Courses', icon: <StudentIcon /> },
        { id: 4, value: 95, suffix: '%', label: 'Success Rate', icon: <StudentIcon /> },
    ];
