          ...
          <div className="p-3">
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
              ...
              <div className="lg:col-span-2 space-y-8">
                {/* About Section */}
                <div className="bg-gray-50/50 dark:bg-gray-700/20 rounded-2xl p-6 transition-all duration-300 hover:shadow-lg">
                ...
                <div className="grid grid-cols-1 md:grid-cols-1 gap-6">
                  <div className="bg-white dark:bg-gray-700/20 rounded-2xl p-6 transition-all duration-300 hover:shadow-lg">
