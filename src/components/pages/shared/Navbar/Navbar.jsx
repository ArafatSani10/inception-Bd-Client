        ...
        <div className="text-2xl font-extrabold select-none cursor-default">
          <Link to="/">
            <img
              ...
              src={
                isDarkMode
                  ? "https://i.ibb.co/cKzQyBNk/534732164-2212940409145293-5451801233054972764-n.jpg" // dark mode logo
                  : "https://inceptionbd.com/store/1/Untitled%20design%20(3).png" // light mode logo
              }
              alt="Logo"
            />
          </Link>
            ...
            <AnimatePresence>
              {isDropdownOpen && (
                ...
                >
                  ...
                  >
                    <SiLogmein className="text-gray-500 dark:text-gray-400" />
                    Logout
                  </button>
                </motion.div>
              )}
          ...
          <AnimatePresence>
            {isDropdownOpen && (
              <motion.div
                ...
                exit={{ opacity: 0, y: -10 }}
                transition={{ duration: 0.25 }}
                className="absolute top-14 right-3 w-48 bg-white dark:bg-gray-800 rounded-lg shadow-xl border border-gray-200 dark:border-gray-700 z-50 overflow-hidden"
              >
                <div className="px-4 py-3 border-b border-gray-200 dark:border-gray-700">
                  <p className="text-sm font-semibold text-gray-800 dark:text-gray-200">
                    {user?.displayName}
