                      ...
                      >
                        ...
                        <div className="aspect-video w-full h-full">
                          <iframe className="w-full h-full md:w-[900px] md:h-[500px]"
                            src="https://www.youtube.com/embed/HA3HXzYdIX4?si=GCMZt4LARDLFqtG_"
  ...
  gyroscope; picture-in-picture" allowfullscreen>
          ...
          <div className="lg:w-1/2 relative mt-14 lg:mt-0">
            ...
            <Link to={`/coursedetails/${latestCourse?.slug}`}> <div className="relative max-w-2xl mx-auto w-full">
              <div className="bg-white dark:bg-gray-900 rounded-2xl shadow-xl p-3 w-full relative z-10">
                <div className="flex justify-between items-start mb-4">
                  <div>
                    <h3
                      className="text-xl max-sm:text-lg font-bold text-[#00baff] tracking-wide "
                    >
                      {latestCourse?.title}
                    </h3>
                    ...
                    <div className="flex items-center justify-between gap-2 mt-4">
                      ...
                      <div className="bg-[#00baff] text-white md:px-3 px-6 max-sm:text-xs  py-2 rounded-full text-sm font-medium">
                        TrendingCourse
                      </div>
                ...
                <div className="flex justify-between items-center">
                  ...
                  <div className="flex items-center gap-3">
                    <div className="flex gap-3 items-center">
                      ...
                      />
                      <h3 className="mt-1 text-sm font-semibold text-[#00baff] dark:text-[#00baff] ">
                  ...
                  <div className="text-right">
                    <div className="text-xl max-sm:text-base font-bold text-[#00baff]">
