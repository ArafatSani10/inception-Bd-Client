          ...
          <div className="lg:w-1/2 relative mt-10 lg:mt-0">
            <div className="relative max-w-2xl mx-auto w-full">
              <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-3 w-full relative z-10">
                <div className="flex justify-between items-start mb-4">
                  <div>
                    <h3 className="text-xl max-sm:text-xs text-gray-900 dark:text-white font-semibold">
                      {latestCourse.title}
                    </h3>
                    <div className="flex items-center gap-2 mt-2">
                      <div className="flex items-center">
              ...
              {/* Decorative elements */}
              <div className="absolute -top-6 -left-6 w-24 h-24 bg-[#00baff] rounded-full animate-float1"></div>
              <div className="absolute -bottom-6 -right-6 w-32 h-32 bg-[#00baff] rounded-full animate-float2"></div>
